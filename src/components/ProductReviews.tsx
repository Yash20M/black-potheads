                      ...
                      {user && review.user?._id === user._id && (
                        <div className="flex gap-2 sm:ml-4">
                          <button
                            ...
                            className="p-2 border border-gray-300 hover:bg-gray-900 hover:text-white hover:border-gray-900 transition-colors"
                            title="Edit review"
                          >
                          ...
                          <button
                            ...
                            className="p-2 border border-red-300 text-red-600 hover:bg-red-600 hover:text-white hover:border-red-600 transition-colors"
                            title="Delete review"
                          >
