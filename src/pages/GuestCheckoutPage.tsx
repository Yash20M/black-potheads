        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              ...
              {/* Easy Tracking Info */}
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200 dark:border-green-700 rounded-lg p-4 text-center">
                <p className="text-sm text-green-900 dark:text-green-100">
                  📦 <strong>Easy Tracking:</strong> You can track your order anytime using just your email or phone number - no Order ID needed!
                </p>
              </div>
